dataSetVersion = "2020-01-24"; // Change this when creating a new data set version. YYYY-MM-DD format.
...
dataSet[dataSetVersion].options = [
  {
    ...
    checked: true,
    sub: [
      { name: "Aurora Dream", key: "aurora" },
      { name: "Dear My Future", key: "dearmf" },
      { name: "Rainbow Live", key: "rainbow" },
      { name: "All Star Selection", key: "allstar" },
      { name: "PriPara", key: "pripara" },
      { name: "Idol Time PriPara", key: "yumekawa" },
      { name: "Kiratto PriChan", key: "kiratto" },
      { name: "King of Prism", key: "kop" }     
    ]
  },  
];
